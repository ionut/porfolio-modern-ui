...
const BlogCard = ({ blog, id }) => {
    ...
    return (
        <>
            <Link href={`/blogs/${id}`} className="grid grid-rows-subgrid row-3 bg-[rgba(34,136,136,.1)] dark:bg-[rgba(17,61,61,.2)] text-black dark:text-white border-neutral-200 dark:border-slate-800">
                <figure>
                ...
                <div className="flex justify-between p-4">
                    <div className="flex gap-2 ">
                        <Image src='/peacock640.jpg' alt="user" width={75} height={75} className='rounded-full' />
